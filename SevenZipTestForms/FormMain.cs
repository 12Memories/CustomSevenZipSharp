...
namespace SevenZipTestForms
{
    public partial class FormMain : Form
    {
        ...
        void extr_ExtractionFinished(object sender, EventArgs e)
        {
            ...
            pb_ExtractProgress.Value = 100;
            pb_ExtractWork.Value = 100;
        ...
        private void buttonToStreamDic_Click(object sender, EventArgs e)
        {
            using (var extr = new SevenZipExtractor(ofd_Archive.FileName))
            {
                var test = extr.ExtractToStreamDictionary();
            }
        }
    }
}
